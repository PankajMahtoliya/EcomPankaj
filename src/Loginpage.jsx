        ...
        >
          <Form className="flex flex-col p-5 space-y-4 bg-white rounded-md shadow-md w-80">
            ...
            <div className=" text-sm text-gray-400">
              ...
              <Link
                to="/auth/sign-up"
                className="px-2 py-1 text-white  hover:bg-[#be2c34] bg-[#002D62]  rounded-xl"
              >
                Signup
              </Link>
            </div>
            <button
              type="submit"
              className="p-2 mx-1 text-white  rounded-lg hover:bg-[#be2c34] bg-[#002D62] "
            >
              Login
            </button>
          </Form>
