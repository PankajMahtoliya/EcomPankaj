        ...
        >
          <Form class="flex flex-col  w-96 p-5 rounded-xl shadow-md bg-white space-y-4">
            ...
            <div className="text-gray-400 font-serif text-sm space-x-6">
              ...
              <Link
                to="/auth/sign-in"
                class="text-white hover:bg-[#be2c34] bg-[#002D62] px-2 py-1 rounded-xl"
              >
                Login
              </Link>
            </div>
            <button
              type="submit"
              className=" hover:bg-[#be2c34] rounded-lg bg-[#002D62] text-white font-serif p-2 mx-1"
            >
              Create My Account
            </button>
          </Form>
